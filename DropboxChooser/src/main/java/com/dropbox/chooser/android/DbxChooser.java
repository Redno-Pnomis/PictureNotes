 ...
 * <p/>
 * <p>
 * The result will be received in the onActivityResult callback of the Activity or Fragment supplied to {@link com.dropbox.chooser.android.DbxChooser#launch}.
 * </p>
 */
public class DbxChooser {
    ...
    public static class Result {
         ...
         *               If the request code doesn't match the one provided to {@link com.dropbox.chooser.android.DbxChooser#launch(Activity, int)} or if the result code
